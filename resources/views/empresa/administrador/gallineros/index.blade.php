 	...
 	<div class="tab-content">
 		<template>
    		<div id="home" class="tab-pane fade in active">
        		 <h3>gallineros libres</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.gallineros.tabs.tab1')
        		</div>
    		</div>
    	</template>
    	...
    	<template>
    		<div id="menu2" class="tab-pane fade">
         		<h3>Gallineros en producción</h3>
      	    		<div class="form-row">
          			@include('empresa.administrador.gallineros.tabs.tab2')
